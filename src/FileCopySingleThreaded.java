...
//nächste Zeile: try with resources genannt, resource in runden Klammern, virtueller finally Block, in dem die geöffnete Res geschlossen wird, egal wie der try block verlassen wurde
//Wichtig: Hilfreich für das verlangte Schließen der Res.
// bei multi threading komplex, weil in einem thread geöffnet und in anderem geschlossen
...
// nur soviel schreiben wie man gelesen hat, sicher: es wurde min 1 gelesen, aber der buffer muss nicht komplett gefüllt sein
				}
			}
		}
